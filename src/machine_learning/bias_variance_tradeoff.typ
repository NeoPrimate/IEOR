...
= Bias–Variance Tradeoff <machine_learning_bias_variance_tradeoff>
...
#let f3(x) = (
  0.099
    + 560.092 * calc.pow(x, 1)
    + -30196.239 * calc.pow(x, 2)
    + 670093.820 * calc.pow(x, 3)
    + -8240509.686 * calc.pow(x, 4)
    + 63978288.580 * calc.pow(x, 5)
    + -336651398.666 * calc.pow(x, 6)
    + 1251770636.215 * calc.pow(x, 7)
    + -3369131367.041 * calc.pow(x, 8)
    + 6638391292.468 * calc.pow(x, 9)
    + -9577148937.546 * calc.pow(x, 10)
    + 9999060435.138 * calc.pow(x, 11)
    + -7350418827.953 * calc.pow(x, 12)
    + 3606448825.648 * calc.pow(x, 13)
    + -1059663131.190 * calc.pow(x, 14)
    + 140964235.978 * calc.pow(x, 15)
)
