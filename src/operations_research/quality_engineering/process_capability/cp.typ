...
= Cp <operations_research_quality_engineering_process_capability_cp>
...
#example[
  ...
  #align(center)[
    #table(
      ...
      table.hline(),
      [Process 1],
      [#calc.round(stats1.mean, digits: 3)],
      [#calc.round(stats1.std_dev, digits: 3)],
      [#calc.round(stats1.cp, digits: 3)],
      [Good],
      [Process 2],
      [#calc.round(stats2.mean, digits: 3)],
      [#calc.round(stats2.std_dev, digits: 3)],
      [#calc.round(stats2.cp, digits: 3)],
      [Marginal],
      [Process 3],
      [#calc.round(stats3.mean, digits: 3)],
      [#calc.round(stats3.std_dev, digits: 3)],
