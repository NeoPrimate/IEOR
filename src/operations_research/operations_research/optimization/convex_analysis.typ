...
$
  f(macron(x)) & = f(lambda x'' + (1 - lambda) x') \
               & gt f(x') \
...
$
  f(lambda x_1 + (1 - lambda) x_2) & = c^T (lambda x_1 + (1 - lambda) x_2) + b \
...
$
  g_i (lambda x_1 + (1 - lambda) x_2) & lt.eq lambda g_i (x_1) + (1 - lambda) g_i (x_2) \
...
$
  gradient f(x) = vec((partial f(x)) / (partial x_1), dots.v, (partial f(x)) / (partial x_n))
  quad quad gradient^2 f(x) = H_f = mat(
    (partial^2 f(x)) / (partial x_1^2), dots, (partial^2 f(x)) / (partial x_1 partial x_n);
    dots.v, dots.down, dots.v;
    (partial^2 f(x)) / (partial x_n partial x_1), dots, (partial^2 f(x)) / (partial x_n^2);
  )
$
...
#example[
  ...
  $
    gradient f(x)
    = vec((partial f(x)) / (partial x_1), (partial f(x)) / (partial x_2), (partial f(x)) / (partial x_3))
  ...
  $
    gradient^2 f(x) =
    mat(
      (partial^2 f(x)) / (partial x_1^2), (partial^2 f(x)) / (partial x_1 partial x_2), (partial^2 f(x)) / (partial x_1 partial x_3);
      (partial^2 f(x)) / (partial x_2 partial x_1), (partial^2 f(x)) / (partial x_2^2), (partial^2 f(x)) / (partial x_2 partial x_3);
      (partial^2 f(x)) / (partial x_3 partial x_1), (partial^2 f(x)) / (partial x_3 partial x_2), (partial^2 f(x)) / (partial x_3^2)
    )
    = mat(
      2, 0, 0;
      0, 0, 1;
...
#example[
  ...
  $
    x^T A x & = mat(x_1, x_2) mat(2, 1; 1, 2) vec(x_1, x_2) \
            \
