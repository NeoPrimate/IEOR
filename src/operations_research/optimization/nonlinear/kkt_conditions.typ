...
= KKT Conditions <operations_research_optimization_nonlinear_kkt_conditions>
  ...
  *Step 3. Stationarity*
  ...
  $
    gradient_x cal(L) = vec(
      (partial cal(L)) / (partial x_1),
      (partial cal(L)) / (partial x_2),
    ) & = vec(
          2x_1 + lambda x_1,
          2x_2 - lambda,
        ) = 0
...
#example[
  ...
  $
    partial / (partial q_1) cal(L) = a_1 - 2 b_1 q_1 - lambda = 0 \
    partial / (partial q_2) cal(L) = a_2 - 2 b_2 q_2 - lambda = 0 \
  $
  ...
  $
    (partial f) / (partial q_1) = a_1 - 2b_1 q_1 \
    (partial f) / (partial q_2) = a_2 - 2b_2 q_2 \
  $
  ...
  $
    (partial^2 f) / (partial q_1^2) = -2b_1 lt 0 \
    (partial^2 f) / (partial q_2^2) = -2b_2 lt 0 \
  $
  ...
  $
       (partial cal(L)) / (partial q_1) & = a_1 - 2 b_1 q_1 - lambda \
...
#example[
  ...
  $
    (partial cal(L)) / (partial x_1) & = 1 - 2(lambda_1 - lambda_2) x_1 = 0 quad quad                & ("DFF-1") \
    (partial cal(L)) / (partial x_2) & = -1 - 2 (lambda_1 - lambda_2) x_2 + 4 lambda_2 = 0 quad quad & ("DFF-2") \
  $
  ...
  *Case 2.* ($lambda_1 gt 0, lambda_2 = 0$)
  ...
  $
    cases(
      (partial cal(L)) / (partial x_1) & = 1 - 2 lambda_1 x_1 + 2 lambda_2 x_1 = 0,
      (partial cal(L)) / (partial x_2) & = -1 - 2 lambda_1 x_2 + 2 lambda_2 (x_2 + 2) = 0,
    )
  $
...
$
  z^* (lambda) & = max_(x gt.eq 0) c^T x + lambda^T (b - A x) \
