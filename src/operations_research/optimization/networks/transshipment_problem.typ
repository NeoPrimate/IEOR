...
= Transshipment Problem <operations_research_optimization_networks_transshipment_problem>

Generalization of the #link(<operations_research_optimization_networks_transportation_problem>)[transportation problem] allowing *intermediate transshipment nodes* — locations that neither produce nor consume, but pass flow through.
...
In practice solve directly as an LP, or use #link(<operations_research_optimization_networks_network_simplex>)[network simplex].
...
- *Min-cost flow generalization* — see #link(<operations_research_optimization_networks_multi_commodity_network_flow>)[MCNF]

== See also

- *#link(<operations_research_optimization_networks_transportation_problem>)[Transportation Problem]* — special case (no intermediates)
- *#link(<operations_research_optimization_networks_multi_commodity_network_flow>)[Multi-Commodity Network Flow]*
