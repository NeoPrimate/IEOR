...
#align(center)[
  #table(
    ...
    [Non-negativity], [], [$ x_i, s_i, a_i gt.eq 0 quad forall i $],
    [Lower Bound ≠ 0],
    [Substitution],
    [$ x_1 gt.eq 5 \
    y_1 = x_1 - 5 \
...
#example[
  ...
  *Step 4*: Determine leaving variable
  ...
  #align(
    center,
    table(
      fill: (x, y) => if x in (1, 6, 8) and y in (0, 1, 2, 3) {
        red.lighten(70%)
      },
  ...
  #align(
    center,
    table(
      fill: (x, y) => if x in (0, 6) and y in (2,) {
        red.lighten(70%)
      },
      columns: range(7).map(n => auto),
      inset: (x: 0.5em, y: 0.5em),
  ...
  *Step 4*: Determine leaving variable
  ...
  #align(
    center,
    table(
      fill: (x, y) => if x in (2, 6, 8) and y in (0, 1, 2, 3) {
        red.lighten(70%)
      },
      columns: range(9).map(n => auto),
      inset: (x: 0.5em, y: 0.5em),
...
#example[
  ...
  *1. Pivot Column*
  ...
  #align(
    center,
    table(
      fill: (x, y) => if x in (2,) and y in (0, 5) {
        red.lighten(70%)
      },
      columns: range(11).map(n => auto),
      inset: (x: 0.5em, y: 0.5em),
  ...
  *2. Ratio*
  ...
  #align(
    center,
    table(
      fill: (x, y) => if x in (2, 10, 12) and y in (1, 2, 3, 4) {
        red.lighten(70%)
      },
  ...
  #align(
    center,
    table(
      fill: (x, y) => if x in (0, 12) and y in (1,) {
        red.lighten(70%)
      },
      columns: range(13).map(n => auto),
      inset: (x: 0.5em, y: 0.5em),
...
#example[
  ...
  *Step 3*: Perform the Second Pivot
  ...
  #align(
    center,
    table(
      fill: (x, y) => if y in (0, 5) and x in (3,) {
        red.lighten(70%)
      },
      columns: range(11).map(n => auto),
      inset: (x: 0.5em, y: 0.5em),
  ...
  #align(
    center,
    table(
      fill: (x, y) => if y in (1, 2, 3, 4) and x in (3, 10, 12) {
        red.lighten(70%)
      },
      columns: range(13).map(n => auto),
      inset: (x: 0.5em, y: 0.5em),
  ...
  #align(
    center,
    table(
      fill: (x, y) => if y in (4,) and x in (0, 12) {
        red.lighten(70%)
      },
      columns: range(13).map(n => auto),
      inset: (x: 0.5em, y: 0.5em),
  ...
  *Step 5*: Perform the Third Pivot
  ...
  #align(
    center,
    table(
      fill: (x, y) => if x in (5,) and y in (0, 5) {
        red.lighten(70%)
      },
      columns: range(11).map(n => auto),
      inset: (x: 0.5em, y: 0.5em),
  ...
  #align(
    center,
    table(
      fill: (x, y) => if x in (5, 10, 12) and y in (1, 2, 3, 4) {
        red.lighten(70%)
      },
      columns: range(13).map(n => auto),
      inset: (x: 0.5em, y: 0.5em),
...
#align(
  ...
  table(
    ...
    table.header([], [$x_1$], [$x_2$], [$dots$], [$x_n$], [$s_1$], [$s_2$], [$dots$], [$s_m$], [RHS]),
    table.hline(),
...
#example[
  ...
  *1. Convert to Canonical Form*
  ...
  #table(
    ...
    table.vline(x: 5, start: 0),
    table.header([], [$x_1$], [$x_2$], [$s_1$], [$s_2$], [RHS]),
    table.hline(),
...
#example[
  ...
  *Step 3.* Reduced costs and entering variable
  ...
  $
    macron(c)_N^T & = c_B^T B^(-1) colorMath(N, #blue) - c_N^T \
                  & = mat(1, 0, 0) mat(
                      1/2, 0, 0;
                      -1, 1, 0;
                      0, 0, 1;
  ...
  *Step 6.* Check optimality (reduced costs)
  ...
  $
    macron(c)_N^T & = c_B^T B^(-1) N - c_N^T \
                  & = mat(1, 0, 0) mat(
                      1/4, 1/4, 0;
                      -1/2, 1/2, 0;
                      1/2, -1/2, 1;
...
#example[
  ...
  *Step 3.* Initial Basis
  ...
  $
        B & = (s_1, s_2, s_3) & quad quad
                                N     & = (x_2, x_2) \
        B & = #nt.print(B)    & quad quad
                                N     & = #nt.print(N) \
    c_B^T & = #nt.print(cBT)  & quad quad
                                c_N^T & = #nt.print(cNT) \
  $
  ...
  *Step 6.* Pivot to the new basis
  ...
  $
        B & = (s_1, s_2, colorMath(x_1, #red)) & quad quad
                                                 N     & = (colorMath(s_3, #red), x_2) \
    #let B = ((1, 0, -1), (0, 1, -1), (0, 0, 3))
    #let N = ((0, 1), (0, 2), (1, 1))
    #let cB = (0, 0, 1)
    #let cBT = nt.r(..cB)
    #let cN = (0, 3)
  ...
  *Step 9.* Pivot to the new basis
  ...
  $
        B & = (s_1, colorMath(x_2, #red), colorMath(x_1, #red)) & quad quad
