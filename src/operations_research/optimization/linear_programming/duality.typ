...
#example[
  ...
  $
    c^T = #colorMat(((1, 0, 0, 0, 0),), ((((0, 0), (0, 1)), red), (((0, 4), (4, 4)), red)))
    quad quad
    A = #colorMat(
      ((2, -1, 1, 0, 0), (2, 1, 0, 1, 0), (0, 1, 0, 0, 1)),
      ((((0, 0), (2, 1)), red), (((0, 4), (4, 4)), red)),
    )
  $
  ...
  $
    c_B^T = #colorMat(((1, 0, 0),), ((((0, 0), (0, 2)), red),))
    quad quad
    A_B = #colorMat(((2, -1, 0), (2, 1, 0), (0, 0, 1)), ((((0, 0), (2, 2)), red),))
  $
...
#proof[
  We have
  $
    c^T macron(x) & = (macron(y)^T A - macron(v)^T) macron(x) \
