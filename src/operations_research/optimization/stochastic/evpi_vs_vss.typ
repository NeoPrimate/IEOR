...
= EVPI vs VSS <operations_research_optimization_stochastic_evpi_vs_vss>
...
From #link(<operations_research_optimization_stochastic_two_stage_recourse>)[two-stage recourse] example:
...
- *#link(<operations_research_decision_analysis_evpi>)[EVPI (Decision Analysis)]* — discrete analog
- *#link(<operations_research_decision_analysis_evsi>)[EVSI]* — value of sample info
