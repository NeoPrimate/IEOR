...
= Standard Normal Loss Function <statistics_functions_standard_normal_loss_function>
...
- *Fill rate*: $beta = 1 - (sigma_L #h(0.2em) L(z))/Q$ — see #link(<supply_chain_inventory_service_levels_fill_rate>)[Fill Rate]
...
— see #link(<statistics_functions_pdf>)[PDF], #link(<statistics_functions_cdf>)[CDF], #link(<statistics_functions_sf>)[SF].

== See also

- *#link(<statistics_distributions_gaussian>)[Gaussian Distribution]*
