...
#example(title: $"ETS"(A, M, M)$)[
  ...
  *Step 2 — apply at $t = 1$*
  ...
  $ cL(l_1) = cL(12) dot cT(1) + 0.5 dot (-2.4) \/ cS(1.2) = cL(11) $
  $ cT(b_1) = cT(1) + 0.4 dot (-2.4) \/ (12 dot 1.2) = cT(0.9333) $
  $ cS(s_1) = cS(1.2) + 0.2 dot (-2.4) \/ (12 dot 1) = cS(1.16) $
  ...
  *Step 3 — iterate*
  ...
  #align(center)[
    #table(
      ...
      [2], [10], [$10.2667$], [$-0.2667$], [$cL(10.1333)$], [$cT(0.9236)$], [$cS(0.9948)$],
      [3], [8], [$7.4876$], [$0.5124$], [$cL(9.6798)$], [$cT(0.9489)$], [$cS(0.8109)$],
      [4], [11], [$9.1853$], [$1.8147$], [$cL(10.0927)$], [$cT(1.0239)$], [$cS(1.0395)$],
      [5], [14], [$11.9874$], [$2.0126$], [$cL(11.2015)$], [$cT(1.0927)$], [$cS(1.199)$],
      [6], [12], [$12.1759$], [$-0.1759$], [$cL(12.1511)$], [$cT(1.0864)$], [$cS(0.9919)$],
      [7], [9], [$10.7049$], [$-1.7049$], [$cL(12.1493)$], [$cT(1.0172)$], [$cS(0.7851)$],
      [8], [13], [$12.8459$], [$0.1541$], [$cL(12.4317)$], [$cT(1.022)$], [$cS(1.042)$],
      [9], [16], [$15.2334$], [$0.7666$], [$cL(13.0253)$], [$cT(1.0426)$], [$cS(1.211)$],
      [10], [14], [$13.4706$], [$0.5294$], [$cL(13.8471)$], [$cT(1.059)$], [$cS(0.9997)$],
      [11], [11], [$11.5129$], [$-0.5129$], [$cL(14.3373)$], [$cT(1.0401)$], [$cS(0.7781)$],
      [12], [15], [$15.5389$], [$-0.5389$], [$cL(14.6539)$], [$cT(1.0257)$], [$cS(1.0348)$],
      [13], [18], [$18.202$], [$-0.202$], [$cL(14.9469)$], [$cT(1.0211)$], [$cS(1.2083)$],
      [14], [16], [$15.2587$], [$0.7413$], [$cL(15.6336)$], [$cT(1.041)$], [$cS(1.0094)$],
      [15], [13], [$12.6634$], [$0.3366$], [$cL(16.4906)$], [$cT(1.052)$], [$cS(0.7823)$],
      [16], [17], [$17.9523$], [$-0.9523$], [$cL(16.8888)$], [$cT(1.0297)$], [$cS(1.0238)$],
    )
  ]
]
