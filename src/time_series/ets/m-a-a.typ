...
#example(title: $"ETS"(M, A, A)$)[
  ...
  *Step 2 — apply at $t = 1$*
  ...
  $ epsilon_1 = (x_1 - mu_1) \/ mu_1 = (12 - 14.5) \/ 14.5 = -0.1724 $
  $ cL(l_1) = cL(12) + cT(0.5) + 0.5 dot 14.5 dot (-0.1724) = cL(11.25) $
  $ cT(b_1) = cT(0.5) + 0.4 dot 14.5 dot (-0.1724) = cT(-0.5) $
  $ cS(s_1) = cS(2) + 0.2 dot 14.5 dot (-0.1724) = cS(1.5) $
  ...
  *Step 3 — iterate*
  ...
  #align(center)[
    #table(
      ...
      [1], [12], [$14.5$], [$-0.1724$], [$cL(11.25)$], [$cT(-0.5)$], [$cS(1.5)$],
      [2], [10], [$10.75$], [$-0.0698$], [$cL(10.375)$], [$cT(-0.8)$], [$cS(-0.15)$],
      [3], [8], [$6.575$], [$0.2167$], [$cL(10.2875)$], [$cT(-0.23)$], [$cS(-2.715)$],
      [4], [11], [$11.0575$], [$-0.0052$], [$cL(10.0287)$], [$cT(-0.253)$], [$cS(0.9885)$],
      [5], [14], [$11.2757$], [$0.2416$], [$cL(11.1379)$], [$cT(0.8367)$], [$cS(2.0449)$],
      [6], [12], [$11.8246$], [$0.0148$], [$cL(12.0623)$], [$cT(0.9069)$], [$cS(-0.1149)$],
      [7], [9], [$10.2542$], [$-0.1223$], [$cL(12.3421)$], [$cT(0.4052)$], [$cS(-2.9658)$],
      [8], [13], [$13.7358$], [$-0.0536$], [$cL(12.3794)$], [$cT(0.1109)$], [$cS(0.8413)$],
      [9], [16], [$14.5351$], [$0.1008$], [$cL(13.2227)$], [$cT(0.6968)$], [$cS(2.3378)$],
      [10], [14], [$13.8046$], [$0.0142$], [$cL(14.0172)$], [$cT(0.775)$], [$cS(-0.0758)$],
      [11], [11], [$11.8264$], [$-0.0699$], [$cL(14.379)$], [$cT(0.4444)$], [$cS(-3.1311)$],
      [12], [15], [$15.6648$], [$-0.0424$], [$cL(14.4911)$], [$cT(0.1785)$], [$cS(0.7084)$],
      [13], [18], [$17.0074$], [$0.0584$], [$cL(15.1659)$], [$cT(0.5756)$], [$cS(2.5363)$],
      [14], [16], [$15.6656$], [$0.0213$], [$cL(15.9086)$], [$cT(0.7093)$], [$cS(-0.009)$],
      [15], [13], [$13.4868$], [$-0.0361$], [$cL(16.3745)$], [$cT(0.5146)$], [$cS(-3.2285)$],
      [16], [17], [$17.5975$], [$-0.034$], [$cL(16.5904)$], [$cT(0.2756)$], [$cS(0.5889)$],
    )
  ]
]
