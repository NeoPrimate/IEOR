...
#example(title: $"ETS"(A, "Ad", A)$)[
  ...
  *Step 2 — apply at $t = 1$*
  ...
  $ cL(l_1) = cL(12) + cT(0.8 dot 0.5) + 0.5 dot (-2.4) = cL(11.2) $
  $ cT(b_1) = cT(0.8 dot 0.5) + 0.4 dot (-2.4) = cT(-0.56) $
  $ cS(s_1) = cS(2) + 0.2 dot (-2.4) = cS(1.52) $
  ...
  *Step 3 — iterate*
  ...
  #align(center)[
    #table(
      ...
      [1], [12], [$14.4$], [$-2.4$], [$cL(11.2)$], [$cT(-0.56)$], [$cS(1.52)$],
      [2], [10], [$10.752$], [$-0.752$], [$cL(10.376)$], [$cT(-0.7488)$], [$cS(-0.1504)$],
      [3], [8], [$6.777$], [$1.223$], [$cL(10.3885)$], [$cT(-0.1098)$], [$cS(-2.7554)$],
      [4], [11], [$11.3006$], [$-0.3006$], [$cL(10.1503)$], [$cT(-0.2081)$], [$cS(0.9399)$],
      [5], [14], [$11.5038$], [$2.4962$], [$cL(11.2319)$], [$cT(0.832)$], [$cS(2.0192)$],
      [6], [12], [$11.7471$], [$0.2529$], [$cL(12.0239)$], [$cT(0.7667)$], [$cS(-0.0998)$],
      [7], [9], [$9.882$], [$-0.882$], [$cL(12.1964)$], [$cT(0.2606)$], [$cS(-2.9318)$],
      [8], [13], [$13.3447$], [$-0.3447$], [$cL(12.2325)$], [$cT(0.0706)$], [$cS(0.8709)$],
      [9], [16], [$14.3082$], [$1.6918$], [$cL(13.1349)$], [$cT(0.7332)$], [$cS(2.3576)$],
      [10], [14], [$13.6216$], [$0.3784$], [$cL(13.9106)$], [$cT(0.7379)$], [$cS(-0.0241)$],
      [11], [11], [$11.5692$], [$-0.5692$], [$cL(14.2164)$], [$cT(0.3627)$], [$cS(-3.0456)$],
      [12], [15], [$15.3774$], [$-0.3774$], [$cL(14.3178)$], [$cT(0.1392)$], [$cS(0.7954)$],
      [13], [18], [$16.7867$], [$1.2133$], [$cL(15.0358)$], [$cT(0.5966)$], [$cS(2.6003)$],
      [14], [16], [$15.4889$], [$0.5111$], [$cL(15.7686)$], [$cT(0.6817)$], [$cS(0.0781)$],
      [15], [13], [$13.2684$], [$-0.2684$], [$cL(16.1798)$], [$cT(0.438)$], [$cS(-3.0993)$],
      [16], [17], [$17.3257$], [$-0.3257$], [$cL(16.3674)$], [$cT(0.2202)$], [$cS(0.7303)$],
    )
  ]
]
