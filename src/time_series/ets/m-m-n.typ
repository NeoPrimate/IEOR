...
#example(title: $"ETS"(M, M, N)$)[
  ...
  *Step 2 — apply at $t = 1$*
  ...
  $ cL(l_1) = cL(12) dot cT(1) (1 + 0.5 dot 0) = cL(12) $
  $ cT(b_1) = cT(1) (1 + 0.4 dot 0) = cT(1) $
  ...
  *Step 3 — iterate*
  ...
  #align(center)[
    #table(
      ...
      [3], [8], [$10.2667$], [$-0.2208$], [$cL(9.1333)$], [$cT(0.8509)$],
      [4], [11], [$7.7716$], [$0.4154$], [$cL(9.3858)$], [$cT(0.9923)$],
      [5], [14], [$9.3135$], [$0.5032$], [$cL(11.6568)$], [$cT(1.192)$],
      [6], [12], [$13.8951$], [$-0.1364$], [$cL(12.9476)$], [$cT(1.127)$],
      [7], [9], [$14.5918$], [$-0.3832$], [$cL(11.7959)$], [$cT(0.9542)$],
      [8], [13], [$11.2561$], [$0.1549$], [$cL(12.1281)$], [$cT(1.0134)$],
      [9], [16], [$12.2903$], [$0.3018$], [$cL(14.1451)$], [$cT(1.1357)$],
      [10], [14], [$16.065$], [$-0.1285$], [$cL(15.0325)$], [$cT(1.0773)$],
      [11], [11], [$16.195$], [$-0.3208$], [$cL(13.5975)$], [$cT(0.9391)$],
      [12], [15], [$12.7694$], [$0.1747$], [$cL(13.8847)$], [$cT(1.0047)$],
      [13], [18], [$13.9502$], [$0.2903$], [$cL(15.9751)$], [$cT(1.1214)$],
      [14], [16], [$17.9143$], [$-0.1069$], [$cL(16.9571)$], [$cT(1.0735)$],
      [15], [13], [$18.2027$], [$-0.2858$], [$cL(15.6014)$], [$cT(0.9507)$],
      [16], [17], [$14.8327$], [$0.1461$], [$cL(15.9163)$], [$cT(1.0063)$],
    )
  ]
]
