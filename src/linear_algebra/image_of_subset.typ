...
= Image of Subset <linear_algebra_image_of_subset>

For a #link(<linear_algebra_linear_transformation>)[linear transformation] $T: RR^n -> RR^m$ and a subset $V subset.eq RR^n$, the *image of $V$ under $T$* is:
...
- *#link(<linear_algebra_image>)[Image of a transformation]* — the case $V = RR^n$ (the whole domain)
- *#link(<linear_algebra_preimage>)[Preimage]* — the inverse direction (which inputs produce a given output set)
