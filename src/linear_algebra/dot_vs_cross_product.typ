...
= Dot vs Cross Product <linear_algebra_dot_vs_cross_product>

The #link(<linear_algebra_dot_product>)[dot product] and #link(<linear_algebra_cross_product>)[cross product] are the two fundamental products of vectors. They give complementary geometric information.
...
- *#link(<linear_algebra_cross_product>)[Cross Product]* + *#link(<linear_algebra_cross_product_magnitude>)[Cross Product Magnitude]*
- *#link(<linear_algebra_angles_between_vectors>)[Angles Between Vectors]*
