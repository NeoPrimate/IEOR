...
#example[
  ...
  *Step 1.* Compute minors and cofactors
  ...
  Minor:
  $
    #colorMat(((1, 2, 3), (0, 4, 5), (1, 0, 6)), ((((0, 0), (0, 3)), red), (((0, 0), (2, 0)), red)))
    \
    det(
      mat(
        4, 5;
  ...
  Minor:
  $
    #colorMat(((1, 2, 3), (0, 4, 5), (1, 0, 6)), ((((0, 0), (0, 3)), red), (((0, 1), (2, 1)), red)))
    \
    det(
      mat(
        0, 5;
  ...
  Minor:
  $
    #colorMat(((1, 2, 3), (0, 4, 5), (1, 0, 6)), ((((0, 0), (0, 3)), red), (((0, 2), (2, 2)), red)))
    \
    det(
      mat(
        0, 4;
  ...
  Minor:
  $
    #colorMat(((1, 2, 3), (0, 4, 5), (1, 0, 6)), ((((1, 0), (1, 3)), red), (((0, 0), (2, 0)), red)))
    \
    det(
      mat(
        2, 3;
  ...
  Minor:
  $
    #colorMat(((1, 2, 3), (0, 4, 5), (1, 0, 6)), ((((1, 0), (1, 3)), red), (((0, 1), (2, 1)), red)))
    \
    det(
      mat(
        1, 3;
  ...
  Minor:
  $
    #colorMat(((1, 2, 3), (0, 4, 5), (1, 0, 6)), ((((1, 0), (1, 3)), red), (((0, 2), (2, 2)), red)))
    \
    det(
      mat(
        1, 2;
  ...
  Minor:
  $
    #colorMat(((1, 2, 3), (0, 4, 5), (1, 0, 6)), ((((2, 0), (2, 3)), red), (((0, 0), (2, 0)), red)))
    \
    det(
      mat(
        2, 3;
  ...
  Minor:
  $
    #colorMat(((1, 2, 3), (0, 4, 5), (1, 0, 6)), ((((2, 0), (2, 3)), red), (((0, 1), (2, 1)), red)))
    \
    det(
      mat(
        1, 3;
  ...
  Minor:
  $
    #colorMat(((1, 2, 3), (0, 4, 5), (1, 0, 6)), ((((2, 0), (2, 3)), red), (((0, 2), (2, 2)), red)))
    \
    det(
      mat(
        1, 2;
