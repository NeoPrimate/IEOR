...
#title_page("Organisations")

#include("actor_network.typ")

#include("bounded_rationality.typ")

#include("bureaucracy.typ")

#include("cybernetic.typ")

#include("embeddedness.typ")

#include("functional_theory_stratification.typ")

#include("institutional_theory.typ")

#include("network_theories.typ")

#include("network_theories.typ")

#include("resource_dependency.typ")

#include("scientific_management.typ")

#include("transaction_costs.typ")

#include("organizational_ecology.typ")
